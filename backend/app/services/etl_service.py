...
FACULTAD_MAP = {
    # ══════════════════════════════════════════════════════════════════════════
    # CARRERAS OFICIALES PUCESE — nombres exactos del sistema académico
    # (claves más largas primero — el sort al final lo ordena correctamente)
    # ══════════════════════════════════════════════════════════════════════════

    # ── Enfermería por campus (antes del genérico) ────────────────────────────
    'ENFERMERIA QUININDE':                'Enfermería – Quinindé',
    'ENFERMERÍA QUININDÉ':                'Enfermería – Quinindé',
    'ENFERMERIA QUINDÉ':                  'Enfermería – Quinindé',
    'ENFERMERIA SAN LORENZO':             'Enfermería – San Lorenzo',
    'ENFERMERÍA SAN LORENZO':             'Enfermería – San Lorenzo',
    # ── Educación Básica por modalidad (antes del genérico) ──────────────────
    'EDUCACION BASICA SEMIPRESENCIAL QUININDE': 'Edu. Básica Semi - Quinindé',
    'EDUCACION BASICA SEMIPRESENCIAL':    'Edu. Básica Semi - Quinindé',
    'EDUCACIÓN BÁSICA SEMIPRESENCIAL':    'Edu. Básica Semi - Quinindé',
    'EDUCACION BASICA SEMI QUININDE':     'Edu. Básica Semi - Quinindé',
    ...
    'T ENFERMERÍA':                       'TC Enfermería',
    'TECNICO EN ENFERMERIA':              'TC Enfermería',
    'TÉCNICO EN ENFERMERÍA':              'TC Enfermería',
    'TECNOLOGIA SUPERIOR EN ENFERMERIA':  'TC Enfermería',
    'TECNOLOGÍA SUPERIOR EN ENFERMERÍA':  'TC Enfermería',
    'DESARROLLO DE SOFTWARE':             'TG Desarrollo de Software',
    'TG DESARROLLO DE SOFTWARE':          'TG Desarrollo de Software',
    'TG DESARROLLO':                      'TG Desarrollo de Software',
    'GESTION CULINARIA':                  'TG Gestión Culinaria',
    'GESTIÓN CULINARIA':                  'TG Gestión Culinaria',
    'TG GESTION CULINARIA':               'TG Gestión Culinaria',
    'TG GESTIÓN CULINARIA':               'TG Gestión Culinaria',
    ...
    'CULINARIA':                          'TG Gestión Culinaria',
    'GASTRONOM':                          'TG Gestión Culinaria',
    # ── Medicina ─────────────────────────────────────────────────────────────
    ...
    'CARRERA DE SISTEMAS Y COMPUTACION':  'Tecnologías de la Información',
    'CARRERA DE SISTEMAS':                'Tecnologías de la Información',
    ...
    'CARRERA GESTION AMBIENTAL':          'Ing. Recursos Naturales Renova',
    'INGENIERIA EN RECURSOS NATURALES':   'Ing. Recursos Naturales Renova',
    'RECURSOS NATURALES RENOVABLES':      'Ing. Recursos Naturales Renova',
    'RECURSOS NATURALES':                 'Ing. Recursos Naturales Renova',
    'GESTIÓN AMBIENTAL':                  'Ing. Recursos Naturales Renova',
    'GESTION AMBIENTAL':                  'Ing. Recursos Naturales Renova',
    'AMBIENTAL':                          'Ing. Recursos Naturales Renova',
    # ── Educación Inicial ─────────────────────────────────────────────────────
    'EDUCACION INICIAL':                  'Educación Inicial',
    'EDUCACIÓN INICIAL':                  'Educación Inicial',
    'CARRERA DE EDUCACION INICIAL':       'Educación Inicial',
    # ── Pedagogía de los Idiomas Nacionales y Extranjeros ────────────────────
    'PEDAGOGIA DE LOS IDIOMAS NACIONALES Y EXTRANJEROS': 'Pedagogía Idiomas Nac. Ext.',
    'C DE PEDAGO DE LOS IDIOMAS NAC Y EXTRAN':           'Pedagogía Idiomas Nac. Ext.',
    ...
    'IDIOMA':                             'Pedagogía Idiomas Nac. Ext.',
    'LENGUAS':                            'Pedagogía Idiomas Nac. Ext.',
    # ── Diseño Gráfico ────────────────────────────────────────────────────────
    ...
    # ══════════════════════════════════════════════════════════════════════════
    # UNIDADES NO ACADÉMICAS — mapeadas a '' para excluirlas del ranking
    # ══════════════════════════════════════════════════════════════════════════
    'PRORECTORADO':                       '',
    'RECTORADO':                          '',
    'PROCURADURIA':                       '',
...
class ETLService:
    ...
    def _source_pucetec_hetero(self, staff: dict) -> list:
        ...
        for (ced, per), grp in df_dd.groupby(['_ced', '_per']):
            ...
            recs.append({
                ...
                'facultad':        _map_facultad(dept) or dept,
                'carrera':         dept,
    ...
    def _source_meipa_pucese_data(self, staff: dict, existing: list = None) -> list:
        ...
        for (ced, per) in all_keys:
            ...
            recs.append({
                'docente_nombre':  self._build_nombre(ced, staff, nombre_raw),
                'facultad':        _map_facultad(s.get('unidad_org', '') or ''),
                'carrera':         '',
